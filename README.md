...
The 2nd step is image similarity search. I extracted the image features using InceptionV3 neural network and then feeded it to unsupervised KNN for similar image search in the database. For demo purpose, the database is composed of over 3000 sunglasses items scrapped from Zappos website.
